...
//        car.setUser(user.getName());
//        car.setUserid(user.getId());
//        car.setDate(DateUtil.today());
//        car.setTime(DateUtil.now());
    ...
    public R findAll() {
        return R.success(carService.list());
    }
    ...
    public R findOne(@PathVariable Integer id) {
        return R.success(carService.getById(id));
    }
    ...
    public R findPage(@RequestParam(defaultValue = "") String name,
        ...
        return R.success(carService.page(new Page<>(pageNum, pageSize), queryWrapper));
    }
