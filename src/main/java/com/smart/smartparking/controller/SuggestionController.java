...
public class SuggestionController {
    ...
    public R save(@RequestBody Suggestion suggestion) {
...
//        suggestion.setTime(DateUtil.now());
    ...
    public R findAll() {
        return R.success(suggestionService.list());
    }
    ...
    public R findOne(@PathVariable Integer id) {
        return R.success(suggestionService.getById(id));
    }
    ...
    public R findPage(@RequestParam(defaultValue = "") String name,
        ...
        return R.success(suggestionService.page(new Page<>(pageNum, pageSize), queryWrapper));
    }
